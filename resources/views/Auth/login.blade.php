...
<body>
    ...
    <script src="{{asset ('assets/modoules/js/stisla.js')}}"></script>
    ...
    <!-- Template JS File -->
    <script src="{{asset ('assets/modules/js/scripts.js')}}"></script>
    <script src="{{asset ('assets/modules/js/custom.js')}}"></script>
</body>
